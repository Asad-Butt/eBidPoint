...
{days=="Time Up" && bids.length > 0 && product.status=="accepted" && product.resolved==false && <TouchableOpacity style={{backgroundColor:"#1b1a60",alignItems:"center",borderRadius: 14,
